...
Ein Array der absoluten Wahlergebnisse mit vier Dimensionen wird kreiert:
 ** Wahlkreise (1 ... 299)
...
Ein Array der Wahlberechtigte und goeltigen Stimmen mit vier Dimensionen wird kreiert:
 ** Wahlkreise (1 ... 299)
...
for (i.year in 1:6){
  for(i.now.then in 1:2){
    if (i.now.then==1){
     ...
     if (i.year==6) all.land[,i.year] <- all.land[,i.year]-900
  }
}
...
all.years <- c(2021,2017,2013,2009,2005)
