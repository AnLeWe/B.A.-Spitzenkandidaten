...
file.name.list <- dir("BTW_2025/Outputs/First_Differencing/")
  ...
  for (i.turnout in 0:1) {
    for (i.spillover in 0:1) {
      ...
      if (i.spillover == 0 & i.turnout == 0) {
        ...
        load(file.path("BTW_2025/Outputs/First_Differencing/", file.name))
      } else {
...
# Sort data 
    ...
    pdf(file=paste0("BTW_2025/Outputs/First_Differencing/Figures/",title,".pdf"),
        width=8,
        height=5.5,
        pointsize = 13)#,
        #family = "CM Roman")
