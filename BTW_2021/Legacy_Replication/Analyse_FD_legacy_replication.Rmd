...
```{r}
if (!dir.exists("../Outputs/Estimation_Results_21/Legacy_Replication")) {
  dir.create("../Outputs/Estimation_Results_21/Legacy_Replication", recursive = TRUE)
}

save(all.results.smd,
     all.results.pr,
  file=paste0("../Outputs/Estimation_Results_21/Legacy_Replication/Estimation_Results_PSelect",party.selec.switch,
             "_denom",vote.denom,
...
save(all.results.t1.smd,
     all.results.t1.pr,
  file=paste0("../Outputs/Estimation_Results_21/Legacy_Replication/Exogeneity_Results_PSelect",party.selec.switch,
              "_denom",vote.denom,
              c("","_spillover")[spill.over.switch+1],
              c("","_turnout")[turnout.switch+1],
              c("_gruMinorOnly","")[green.mask.switch+1],
