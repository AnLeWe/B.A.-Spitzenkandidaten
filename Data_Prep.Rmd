...
```
```{r}
data_treat[data_treat$Jahr == 2021 & data_treat$Nr == 61]
```
...
for (i.year in 1:7){ # 2025, 2021, 2017, 2013, 2009, 2005, 2002
  for(i.now.then in 1:2){ # now (1) or then (2)
    ...
    if (i.year < 7){
      ...
      # Second vote
      all.abs.total[,,2,i.year,i.now.then] <- as.matrix(temp.dat[,c(4,7,11)])
      ...
      if (i.now.then==1){
        ...
        # Second vote
        all.abs.total[,,2,i.year,i.now.then] <- as.matrix(temp.dat[,c(4,22,9)])
