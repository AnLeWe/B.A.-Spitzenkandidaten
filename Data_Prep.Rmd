...
all.treat <- array(NA, dim=c(299, 7, 2, 7))         # 7 parties, 7 years
...
for (i.year in 1:7){ # 2025, 2021, 2017, 2013, 2009, 2005, 2002
  ...
  temp.treat <- data_treat[(1+299*(i.year-1)):(299*i.year),] # 2025 for i.year=1, 2021 for i.year=2, etc.
  
  # Treatment
  # First vote - 7 parties
  all.treat[,,1,i.year] <- 
    as.matrix(temp.treat[,seq(12, 24, by=2)])
  # Second vote - 7 parties
  all.treat[,,2,i.year] <-
    as.matrix(temp.treat[,seq(13, 25, by=2)])
}
