...
for (i.smdpr in 1:2){ # first/second vote
  ...
  year <- relevel(year,ref="2009") # Why 2005 before?
  ...
  print(summary(lm.fe2 <- lm(votes~ treat + cross.treat + 
                               last.votes + party * year + district * party))) # why not district * year
...
out_dir <- file.path("Outputs", "Estimation_Results_25", "Fixed_Effects", "/")
if (save.outputs == 1) {
  save(
    all.results.smd,
    all.results.pr,
