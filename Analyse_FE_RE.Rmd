...
```{r}
  ...
  all.rel.votes <-  all.abs.votes/all.abs.total[,rep(2,length(party.selection)),,,] 
...
save(all.results.smd,
     all.results.pr,
 file=paste0("Data/Estimation_Results_FE_PSelect3_denom2.RData")#,party.selec.switch,
              #"_denom"
              #,vote.denom,".RData")
              )
...
save(all.results.smd,
     all.results.pr,
 file=("Data/Exogeneity_Results_FE_PSelect3_denom2.RData"))
